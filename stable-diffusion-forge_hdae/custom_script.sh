...
# [[ -f /workspace/config.json ]] || curl -fsSL "${SDF_CONFIG}/config.json" -o /workspace/config.json
# [[ -f /workspace/ui-config.json ]] || curl -fsSL "${SDF_CONFIG}/ui-config.json" -o /workspace/ui-config.json
